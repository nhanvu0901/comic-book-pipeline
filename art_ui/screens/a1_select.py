...
from art_pipeline.config import ART_MODES
...
def build(page: ft.Page, state: ArtAppState, *,
    ...
    mode_dd = ft.Dropdown(
        ...
        options=[ft.dropdown.Option(m.key, text=m.label) for m in ART_MODES],
    )
    ...
    def start(_e):
        ...
        state.mode = mode_dd.value or "painting_deep_dive"
    ...
    right = ft.Column([
        ...
        ft.Container(height=10),
        ids_tf, name_tf, mode_dd, theme_tf, error_text,
